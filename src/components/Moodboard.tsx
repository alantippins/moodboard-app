          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            >
              <div className="p-6  transition-all duration-500">
                ...
                >
                  {resolvedPalette.name} evokes calm restraint. It&apos;s not
                  trying to be loud or sharp. Instead, it sits comfortably
                  between eras. Modern in shape, nostalgic in warmth. The kind
                  of palette that breathes.
                </p>
              </div>
            </div>
